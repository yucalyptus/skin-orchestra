...
<p>私は美容医療に長く携わってきました。でも正直に言うと、最初は「レーザーでコラーゲンを増やす」と説明しながら、その裏で細胞に何が起きているのかを、うまくイメージできていませんでした。コラーゲンを作るのは線維芽細胞（fibroblast）で、そのコラーゲンは細胞のなかでアミノ酸からタンパク質として合成される――いまなら当たり前に語れることも、当時は「言葉」として知っていただけで、絵が浮かんでいませんでした。</p>
<p>医学部で習った生化学や細胞生物学は、日々の臨床からは遠ざかりがちです。そこまで立ち返らなくても、現場の仕事は回る。けれど、<strong>自分たちが美容でやっている施術が細胞に何をしているのか</strong>を本当に理解しようとすると、その基礎の視点がどうしても必要になります。</p>
<p>すべてを完全に理解するのは難しいかもしれない。それでも、医学部で積んだ基礎と今の臨床がつながっていること、そして細胞・生化学のレベルまでイメージできると、治療の選び方が変わってくる――そう信じてこの教材を作っています。</p>
