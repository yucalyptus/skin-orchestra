...
> [[organelles]]以降、転写も翻訳も折りたたみも輸送も ATP を使う、と繰り返し書いてきました。**ではその ATP は、どこから来るのか。** この章では、その経路をたどります。

## この章の一言

> 食べたもの、あるいは体に蓄えてあったものを分解すると、**電子**が取り出されます。その電子を **NAD⁺** が受け取って運び、酸素へ渡します。**ATPの大半は、その電子の流れの先で作られます。**
>
> できた ATP は、組み立て・輸送・収縮にエネルギーを渡して ADP に戻り、また作り直されます。**ATPは代謝そのものでも、体の材料でもありません。** 壊す側と組み立てる側をつなぐ、一部品です。
